...
abstract class Base {
	...
	protected function start_settings_group($element, $group_name, $group_title ) {
		...
		$element->add_control( $group_name . '_heading', $args );
	}

	protected function end_settings_group($element) {
		$element->add_control(
			$this->current_group,
			[
	...
	protected function add_settings_group_control($element, $id, array $args ) {
		...
		return $element->add_control( $id, $args );
	}
}
