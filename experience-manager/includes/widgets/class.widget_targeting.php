				...
				<p>
					<label for="<?php echo $widget->get_field_id('tma_matching'); ?>">
						...
						<select id="<?php echo $widget->get_field_id('tma_matching'); ?>" name="<?php echo $widget->get_field_name('tma_matching'); ?>">
							...
							<option <?php selected($matching, ShortCode_TMA_CONTENT::$match_mode_any); ?> value="<?php echo ShortCode_TMA_CONTENT::$match_mode_any; ?>"><?php _e('Any', 'tma-webtools'); ?></option>
							<option <?php selected($matching, ShortCode_TMA_CONTENT::$match_mode_none); ?> value="<?php echo ShortCode_TMA_CONTENT::$match_mode_none; ?>"><?php _e('None', 'tma-webtools'); ?></option>
						</select>
					</label>
				</p>
				<p>
				<h4><?php _e('Visible for audiences', 'tma-webtools'); ?></h4>
				<?php
