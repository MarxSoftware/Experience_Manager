<div class="exm-content-editor">
	...
	<div class="tab-container">
		<div class="tab">
			<button class="tablinks" data-exm-tab-default="true" data-exm-tab-target="exm_html_editor">Html</button>
			<button class="tablinks" data-exm-tab-target="exm_css_editor" >Css</button>
			<button class="tablinks" data-exm-tab-target="exm_javascript_editor" >JavaScript</button>
		</div>
