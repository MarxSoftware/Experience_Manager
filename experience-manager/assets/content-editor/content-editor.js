...
jQuery(function () {
	...
	document.querySelectorAll(".preview-container .devices button").forEach(($button) => {
		$button.addEventListener("click", (event) => {
			...
			document.querySelector(".exm-content-editor .preview-wrapper").classList.remove("tablet");
			document.querySelector(".exm-content-editor .preview-wrapper").classList.remove("desktop");
			document.querySelector(".exm-content-editor .preview-wrapper").classList.remove("phone");
			document.querySelector(".exm-content-editor .preview-wrapper").classList.add(device);
		});
	});
});