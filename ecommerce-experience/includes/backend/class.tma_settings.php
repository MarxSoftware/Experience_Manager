...
class TMA_Settings {
	...
	function admin_menu() {
		add_menu_page(
				__("Ecommerce Experience", "experience-manager"), __("Ecommerce Experience", "experience-manager"), 'manage_options', 'ecommerce-experience/pages/tma-webtools-admin.php', null, plugins_url('ecommerce-experience/images/settings_16.png'), 50);
		//add_submenu_page('ecommerce-experience/pages/tma-webtools-admin.php', __("Dashboard", "experience-manager"), __("Dashboard", "experience-manager"), 'manage_options', 'ecommerce-experience/pages/tma-webtools-admin.php', null);
		add_submenu_page('ecommerce-experience/pages/tma-webtools-admin.php', __("Settings", "experience-manager"), __("Settings", "experience-manager"), 'manage_options', 'tma-webtools-setting-admin', array($this, 'plugin_page'));
		
		
		add_submenu_page('ecommerce-experience/pages/tma-webtools-admin.php', __("Documentation", "experience-manager"), __("Documentation", "experience-manager"), 'manage_options', 'https://wp-digitalexperience.com/documentation/experience-manager/', null);
	}
